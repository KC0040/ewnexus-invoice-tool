...
function renderInvoiceTemplate(slug, d) {
  switch (slug) {
    ...
    case 'newspaper':      return tmplNewspaper(d);
    case 'blueprint':      return tmplBlueprint(d);
    case 'craft-warm':     return tmplCraftWarm(d);
    case 'neon-night':     return tmplNeonNight(d);
    case 'sports':         return tmplSports(d);
    case 'gradient-mesh':  return tmplGradientMesh(d);
    case 'monochrome':     return tmplMonochrome(d);
    case 'split-sidebar':  return tmplSplitSidebar(d);
    case 'photography':    return tmplPhotography(d);
    case 'restaurant':     return tmplRestaurant(d);
    case 'real-estate':    return tmplRealEstate(d);
    case 'gold-luxury':    return tmplGoldLuxury(d);
    case 'retro-70s':      return tmplRetro70s(d);
    case 'timeline':       return tmplTimeline(d);
    case 'handwritten':    return tmplHandwritten(d);
    case 'map-jobsite':    return tmplMapJobsite(d);
    case 'swiss-type':     return tmplSwissType(d);
    case 'neon-cyber':     return tmplNeonCyber(d);
